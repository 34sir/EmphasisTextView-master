...
public class EmphasisTextView extends TextView {
    ...
    public void highlight() {
        ...
        if (!TextUtils.isEmpty(getText()) && !textToHighlight.isEmpty()) {
            ...
            while (matcher.find()) {
//              final BackgroundColorSpan colorSpan = new BackgroundColorSpan(highlightColor);  //特定文字背景高亮
                final ForegroundColorSpan colorSpan=new ForegroundColorSpan(highlightColor);  //特定文字高亮
